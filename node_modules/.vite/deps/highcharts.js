...
// src/node_modules/highcharts/highcharts.js
var require_highcharts = __commonJS({
  "src/node_modules/highcharts/highcharts.js"(exports, module) {
    !/**
 ...
 - ${i11}: ${e11}`, r10 && (a10 += encodeURI(i11) + "=" + encodeURI(e11));
      ...
      class eK {
        ...
        shadow(t10) {
          let { renderer: e10 } = this, i10 = ej(this.parentGroup?.rotation === 90 ? { offsetX: -1, offsetY: -1 } : {}, eX(t10) ? t10 : {}), s10 = e10.shadowDefinition(i10);
      ...
      class iU {
        ...
        symbol(t10, e10, i10, s10, o10, r10) {
          ...
          if (u2) "number" == typeof e10 && (n10 = u2.call(this.symbols, e10 || 0, i10 || 0, s10 || 0, o10 || 0, r10)), a10 = this.path(n10), d2.styledMode || a10.attr("fill", "none"), iN(a10, { symbolName: g2 || void 0, x: e10, y: i10, width: s10, height: o10 }), r10 && iN(a10, r10);
            ...
            s11.imgwidth = iX(r10?.width, iC[h10]?.width), s11.imgheight = iX(r10?.height, iC[h10]?.height), l2 = (t11) => t11.attr({ width: t11.width, height: t11.height }), ["width", "height"].forEach((t11) => {
      ...
      class s$ {
        ...
        adjustTickAmount() {
          let t10 = this, { finalTickAmt: e10, max: i10, min: s10, options: o10, tickPositions: r10, tickAmount: a10, thresholdAlignment: n10 } = t10, h10 = r10?.length, l2 = sF(t10.threshold, t10.softThreshold ? 0 : null), d2, c2, p2 = t10.tickInterval, g2, u2 = () => r10.push(sT(r10[r10.length - 1] + p2)), f2 = () => r10.unshift(sT(r10[0] - p2));
      ...
      class oq {
        ...
        getNestedProperty(t10) {
          if (t10) return 0 === t10.indexOf("custom.") ? oF(t10, this.options) : this[t10];
        }
        getZone() {
        ...
        optionsToObject(t10) {
          ...
          else if (oX(t10)) for (!i10 && t10.length > o10 && ("string" == (a10 = typeof t10[0]) ? e10.xAxis?.dateTime ? r10.x = e10.chart.time.parse(t10[0]) : r10.name = t10[0] : "number" === a10 && (r10.x = t10[0]), n10++); h10 < o10; ) i10 && void 0 === t10[n10] || (s10[h10].indexOf(".") > 0 ? oq.prototype.setNestedProperty(r10, t10[n10], s10[h10]) : r10[s10[h10]] = t10[n10]), n10++, h10++;
      ...
      class r0 {
        ...
        findPointIndex(t10, e10) {
          ...
          if (r10) {
            ...
            if (h10?.matchByName ? e11 = (e12) => !e12.touched && e12.name === t10.name : this.options.relativeXValue && (e11 = (e12) => !e12.touched && e12.options.x === t10.x), !(i10 = rX(n10, e11))) return;
          }
        ...
        generatePoints() {
          ...
          for (h10 && n10 && (this.options.keys = false), x2 = 0; x2 < r10; x2++) f2 = a10 + x2, n10 ? ((m2 = new o10(this, i10.getRow(x2, g2) || [])).dataGroup = this.groupMap[d2 + x2], m2.dataGroup?.options && (m2.options = m2.dataGroup.options, rF(m2, m2.dataGroup.options), delete m2.dataLabels)) : (m2 = y2[f2], b2 = e10 ? e10[f2] : i10.getRow(x2, p2), m2 || void 0 === b2 || (y2[f2] = m2 = new o10(this, b2, s10[x2]))), m2 && (m2.index = n10 ? d2 + x2 : f2, l2[x2] = m2, m2.category = c2?.[m2.x] ?? m2.x, m2.key = m2.name ?? m2.category);
      ...
      class a0 {
        ...
        getAxisMargins() {
          ...
          t10.hasCartesianSeries ? o10(t10.axes) : i10?.length && o10(i10), aM.forEach(function(i11, o11) {
        ...
        transform(t10) {
          ...
          for (let t11 of e10) {
            ...
            let { dataMin: E2, dataMax: I2, min: D2, max: B2 } = az(t11.getExtremes(), O2 || {}), N2 = l2.parse(f2.min), z2 = l2.parse(f2.max), R2 = E2 ?? N2, W2 = I2 ?? z2, H2 = L2 - P2, F2 = t11.categories ? 0 : Math.min(H2, W2 - R2), X2 = R2 - F2 * (aE(N2) ? 0 : f2.minPadding), G2 = W2 + F2 * (aE(z2) ? 0 : f2.maxPadding), j2 = t11.allowZoomOutside || 1 === k2 || "zoom" !== n10 && k2 > 1, Y2 = Math.min(N2 ?? X2, X2, j2 ? D2 : X2), U2 = Math.max(z2 ?? G2, G2, j2 ? B2 : G2);
        ...
        for (let i10 of t10.series || []) if (i10.visible && i10.hasDataLabels?.()) {
          let s10 = (i11) => {
            for (let s11 of i11) s11.visible && (s11.dataLabels || []).forEach((i12) => {
              let o10 = i12.options || {};
              i12.labelrank = lo(o10.labelrank, s11.labelrank, s11.shapeArgs?.height), o10.allowOverlap ?? Number(o10.distance) > 0 ? (i12.oldOpacity = i12.opacity, i12.newOpacity = 1, la(i12, t10)) : e10.push(i12);
            });
          };
      ...
      function lv() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let { options: t10, yAxis: e10 } = this, i10 = "percent" === t10.stacking, s10 = ll.plotOptions?.[this.type]?.borderRadius, o10 = lk(t10.borderRadius, lg(s10) ? s10 : {}), r10 = e10.options.reversed;
      ...
      !function(t10) {
        ...
        function i10(t11, e11) {
          ...
          let a10 = lA(...o10.map((t12) => lC(i11?.rules || [], (e12) => e12._id === t12)).map((t12) => t12?.chartOptions));
